...
export default function FilmRecommendDe({change}) {
  ...
  return (
    <Box>
      <div style={{marginLeft: '5%', width: '82%', marginTop: '15px', marginBottom: '15px', justifyContent: 'space-between', display: 'flex', alignItems: 'center' }}>
       <div style ={{fontSize: '25px', fontFamily: 'monospace', display: 'flex', alignItems:'center'}}>RECOMMEND FOR YOU (DECISION TREE MODEL) <ChangeCircleIcon style={{fontSize: '30px', cursor: 'pointer'}} onClick= {change}/></div> 
        <Link to ='/recommend_decisionTree' style={{textDecoration: 'none', marginTop: '15px'}}>See more....</Link>
      </div>
